...
DEVICE="RE54E4L1"
if [[ "$1" == "rui" ]]; then
	VERSION="MiNaZuKi-${DEVICE^^}-RUI-${DATE}"
else
...
# Make defconfig
make -j${KEBABS} ${ARGS} -j$(nproc --all) ${DEVICE}_defconfig

if [[ "$1" == "rui" ]]; then
	sed -i "s/qcom,mdss-dsi-bl-max-level = <2047>;/qcom,mdss-dsi-bl-max-level = <4095>;/g" ${dts_source}/21733/dsi-panel-oplus21623-samsung-ams662zs01-1080-2400-dsc-cmd.dtsi
	sed -i "s/qcom,mdss-brightness-max-level = <2047>;/qcom,mdss-brightness-max-level = <4095>;/g" ${dts_source}/21733/dsi-panel-oplus21623-samsung-ams662zs01-1080-2400-dsc-cmd.dtsi
	sed -i "s/qcom,mdss-dsi-bl-max-level = <2047>;/qcom,mdss-dsi-bl-max-level = <4095>;/g" ${dts_source}/21623/dsi-panel-oplus21623-samsung-ams662zs01-1080-2400-dsc-cmd.dtsi
	sed -i "s/qcom,mdss-brightness-max-level = <2047>;/qcom,mdss-brightness-max-level = <4095>;/g" ${dts_source}/21623/dsi-panel-oplus21623-samsung-ams662zs01-1080-2400-dsc-cmd.dtsi
fi
